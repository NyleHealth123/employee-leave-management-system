...
- [ ] T103 [P] [US4] Add accessible own-request cancellation controls and confirmation that submit the loaded request version, explain eligibility/cutoff, and refresh after success or stale conflict in `frontend/src/features/leave-requests/LeaveRequestHistoryPage.tsx` (FR-013, FR-032)
