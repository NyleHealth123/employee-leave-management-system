...
- [ ] T127 Execute every acceptance scenario in `specs/001-employee-leave-management/quickstart.md` against a clean local PostgreSQL volume initialized with the profile-isolated T118 local-demo dataset and reset/recreation support from T125; document verified results in `specs/001-employee-leave-management/quickstart.md`
