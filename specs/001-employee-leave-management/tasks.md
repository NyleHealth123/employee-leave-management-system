...
- [ ] T126 Run `backend/mvnw.cmd verify`, `frontend` lint/typecheck/test/build, and `e2e` smoke tests using the profile-isolated T118/T125 local-demo dataset where demo/E2E verification applies; record commands and any platform-specific notes in `README.md`
