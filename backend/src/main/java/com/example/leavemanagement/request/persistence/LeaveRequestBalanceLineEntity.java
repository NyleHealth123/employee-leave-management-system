...
public class LeaveRequestBalanceLineEntity {
    ...
    public void consume(){state="CONSUMED";updatedAt=Instant.now();} public void release(){state="RELEASED";updatedAt=Instant.now();} public void restore(){state="RESTORED";updatedAt=Instant.now();}
    public void reserve(){state="RESERVED";updatedAt=Instant.now();}
}
