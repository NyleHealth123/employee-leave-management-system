...
public class LeaveBalanceService {
    ...
    private BalanceView view(LeaveBalanceEntity b){return new BalanceView(b.getId(),b.getLeaveTypeId(),policies.typeName(b.getLeaveTypeId()),b.getPeriodStart(),b.getPeriodEnd(),b.getAllocatedUnits()/2.0,b.getReservedUnits()/2.0,b.getConsumedUnits()/2.0,b.getAvailableUnits()/2.0,b.getVersion());}
